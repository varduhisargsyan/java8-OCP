...
public class CustomThreadExplainingThreadAPI_step14 extends Thread {
    ...
    public CustomThreadExplainingThreadAPI_step14(String name) {
        super(name);
    }
 ...
 */
        thread1 = new CustomThreadExplainingThreadAPI_step14("thread1");
        thread2 = new CustomThreadExplainingThreadAPI_step14("thread2");
        thread3 = new CustomThreadExplainingThreadAPI_step14("thread3");
