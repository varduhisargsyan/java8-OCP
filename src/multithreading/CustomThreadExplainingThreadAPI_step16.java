...
public class CustomThreadExplainingThreadAPI_step16 extends Thread {
    ...
    public static void main(String[] args) {
        CustomThreadExplainingThreadAPI_step16 thread1 = new CustomThreadExplainingThreadAPI_step16("CustomThreadExplainingUnsyncMethodCallOFSharedObject_1");
        CustomThreadExplainingThreadAPI_step16 thread2 = new CustomThreadExplainingThreadAPI_step16("CustomThreadExplainingUnsyncMethodCallOFSharedObject_2");
 ...
 */
        thread1 = new CustomThreadExplainingThreadAPI_step16("thread1");
        thread2 = new CustomThreadExplainingThreadAPI_step16("thread2");
        thread3 = new CustomThreadExplainingThreadAPI_step16("thread3");
