 ...
 */
public class CustomThreadExplainingThreadAPI_step18 extends Thread {


    public CustomThreadExplainingThreadAPI_step18(String name) {
        super(name);
    }
    ...
    public static void main(String[] args) {
        CustomThreadExplainingThreadAPI_step18 thread3 = new CustomThreadExplainingThreadAPI_step18("Thread3");
